...
1. Open github-sentinel from your Start menu.
2. Select the Settings tab.
3. Choose the option to link your account.
4. Log in with your GitHub username and password.
5. Approve the permission request to allow the app to view your activity.
6. Select the repositories you want to track.
7. Click Save.
